  ...
  while ($row = mysqli_fetch_array($sql)) {
    ...
    ?>
            ...
            <h3 class="u-align-center u-text u-text-custom-color-3 u-text-default u-text-1">
                <?php echo $row['newsName5']; ?></h3>
            <img class="u-image u-image-default u-image-1" src=<?php echo $row['img5']; ?> alt="" data-image-width="900"
                data-image-height="675">
            <p class="u-align-left u-text u-text-default u-text-2">
                <span style="font-weight: 700;"><?php echo $row['NewsMsg5']; ?>
        </div>
