...
<head>
    ...
    <title>ข่าวสาร 4</title>
    <link rel="icon" type="image/png" href="./images/logo1.png" />
    <link rel="stylesheet" href="nicepage.css" media="screen">
    <link rel="stylesheet" href="Compate4.css" media="screen">
...
<body class="u-body u-xl-mode" data-lang="en">
    ...
    <section class="u-clearfix u-section-1" id="sec-5ded">
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
            ...
            <?php
  $sql = $conn->fetchonerecord4($_GET['id']);
  while ($row = mysqli_fetch_array($sql)) {

    ?>

            <h3 class="u-align-center u-text u-text-custom-color-3 u-text-default u-text-1">
                <?php echo $row['newsName4']; ?></h3>
            <img class="u-image u-image-default u-image-1" src=<?php echo $row['img4']; ?> alt="" data-image-width="900"
                data-image-height="675">
            <p class="u-align-left u-text u-text-default u-text-2">
                <span style="font-weight: 700;"><?php echo $row['NewsMsg4']; ?>
        </div>
